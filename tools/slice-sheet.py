...
def main() -> int:
    ...
    # Key out the magenta backdrop. Match on "red and blue high, green low"
    # rather than an exact colour — the generator's magenta varies per image.
    r, g, b = arr[:, :, 0], arr[:, :, 1], arr[:, :, 2]
    foreground = ~((r > 150) & (b > 150) & (g < 120) & (abs(r - b) < 90))
